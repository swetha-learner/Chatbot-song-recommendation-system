		...
		methods:{init:function(o){
			...
			return a(l).bind("submit",function(e){
				...
				n.each(function(e,t){
					...
					n.trigger("validationLostFocus.validation"),i?(r.options.preventSubmit&&e.preventDefault(),
					t.addClass("error"),
					...
					this.each(function(){var t=a(this),
					...
					if(!l.length&&r.options.autoAdd&&r.options.autoAdd.helpBlocks&&(l=a('<div class="help-block" />'),
						o.find(".controls").append(l),e.push(l[0])),r.options.sniffHtml){
						var c="";
					if(void 0!==t.attr("pattern")&&(c="Not in the expected format\x3c!-- data-validation-pattern-message to override --\x3e",
						...
						t.data("validationMaxMessage",c),t.data("validationMaxMax",v)}
